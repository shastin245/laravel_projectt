...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->ref=='front'){
            ...
            session($sessionData);
            \Stripe\Stripe::setApiKey('sk_test_51NJll2AySojs9jOf6hIja3DwOoy1vCTbNCT4eretsd4ztWXggWSFS5XbIS14jZuYPVWnDdcWO7XLRcffMkW4XWqR00zquHxNUT');
            $session = \Stripe\Checkout\Session::create([
                ...
                'mode' => 'payment',
                'success_url' => 'http://localhost/laravel_mine/laravel_project-master/booking/success?session_id={CHECKOUT_SESSION_ID}',
                'cancel_url' => 'http://localhost/laravel_mine/laravel_project-master/booking/failure',
            ]);
